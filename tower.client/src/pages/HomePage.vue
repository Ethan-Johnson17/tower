    ...
    <div class="col-md-12">
      <div class="row bgImg align-content-center">
        <div class="col-md-3 text-light">
          ...
          inventore maiores illum reprehenderit sunt culpa autem quasi vitae
          voluptatum.
        </div>
      </div>
    </div>
  ...
  <div class="row justify-content-center">
    ...
    >
      <div class="row justify-content-around ps-3">
        <div class="col-md-1 text-center selectable" @click="filter = ''">
          All
        </div>
        <div
          class="col-md-1 text-center selectable"
        ...
        <div class="col-md-1 text-center selectable" @click="filter = 'sport'">
          Sport
        </div>
        <div
          class="col-md-1 text-center selectable"
...
export default {
  ...
  setup() {
    ...
    return {
      ...
      filtered: computed(() =>
        AppState.events.filter((f) => f.type == filter.value)
      ),
      filter,
